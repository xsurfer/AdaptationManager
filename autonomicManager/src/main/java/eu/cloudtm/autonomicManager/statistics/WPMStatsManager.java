 ...
 * <p/>
 * Created by: Fabio Perfetti E-mail: perfabio87@gmail.com Date: 6/6/13
 */
...
public class WPMStatsManager extends SampleProducer implements StatsManager {
   ...
   /**
    * This method returns a StatisticDTO, useful to communicate to RESTInterface. It contains all the sample averages
    * belong nodes
    *
    * @param param
    * @return
