...
//        StatisticDTO statDTO = SampleManager.getInstance().getAllAvgStatistic(paramKey, resourceType);
//
...
//
//        ResourceType resourceType = monitoredParams.get(paramKey);
//        StatisticDTO statDTO = SampleManager.getInstance().getLastAvgStatistic(paramKey, resourceType);
//
//        if ( editParam.containsKey(paramKey) ){
//            //log.info("To evaluate");
//
